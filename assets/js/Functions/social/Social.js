      ...
      <div class="social-grid">
        ...
        <div class="social-card">
          ...
          <div style="display: flex; gap: 5px; justify-content: center; align-items: center;">
            <a href="https://www.youtube.com/channel/UCemKYMAMJk8FggZ5NI36i1Q" class="social-link" target="_blank" data-i18n="link_channel">Channel</a>
            <span class="social-divider">/</span>
            <a href="https://www.youtube.com/@JinghaoChen-Stardust" class="social-link" target="_blank" data-i18n="link_handle">Handle</a>
          </div>
        </div>
        ...
        <div class="social-card">
          ...
          <div style="display: flex; gap: 5px; justify-content: center; align-items: center;">
            <a href="https://www.douyin.com/user/MS4wLjABAAAAqb9M45SaGeb8yI28lL3lDFHm48c4kl32Xq7BfRk3I24" class="social-link" target="_blank" data-i18n="link_link1">Link 1</a>
            <span class="social-divider">/</span>
            <a href="https://v.douyin.com/PzIS6mSXJGY/" class="social-link" target="_blank" data-i18n="link_link2">Link 2</a>
          </div>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://www.xiaohongshu.com/user/profile/64c696da000000000b005093" class="social-link" target="_blank" data-i18n="link_profile">Profile</a>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://www.quora.com/profile/Jinghao-Chen-11/" class="social-link" target="_blank" data-i18n="link_profile">Profile</a>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://x.com/stardust_math" class="social-link" target="_blank" data-i18n="link_profile">Profile</a>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://space.bilibili.com/470364718" class="social-link" target="_blank" data-i18n="link_channel">Channel</a>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://github.com/Stardust-math" class="social-link" target="_blank" data-i18n="link_profile">Profile</a>
        </div>
        ...
        <div class="social-card">
          ...
          <a href="https://steamcommunity.com/id/stardust-math/" class="social-link" target="_blank" data-i18n="link_profile">Profile</a>
        </div>
      </div>
    </div>
    ...
    <div class="container stats-container">
      ...
      <div class="stats-block">
        <div class="stats-subtitle">
          ...
          <a class="stats-link" href="https://stardust.goatcounter.com/" target="_blank" rel="noopener" data-i18n="link_open">Open</a>
        </div>
